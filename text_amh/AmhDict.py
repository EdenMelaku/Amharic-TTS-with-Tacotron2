...
dictt={ 'ሀ': 'HA',  'ሁ': 'HU',  'ሂ': 'HI',  'ሃ': 'HA', 'ሄ': 'HAE', 'ህ': 'H', 'ሆ': 'HO',
        ...
        'ቀ': 'QE', 'ቁ': 'QU', 'ቂ': 'QI', 'ቃ': 'QA', 'ቄ': 'QAE', 'ቅ': 'Q', 'ቆ': 'QO',                     'ቈ': 'QUAA', 'ቊ': 'QUI', 'ቋ': 'QUA', 'ቌ': 'QUE', 'ቍ': 'QWAE', 
        ...
        'ኀ': 'HA', 'ኁ': 'HU', 'ኂ': 'HI', 'ኃ': 'HA', 'ኄ': 'HAE', 'ኅ': 'HI', 'ኆ': 'HO',                     'ኈ': 'HUAA', 'ኊ': 'HUI', 'ኋ': 'HUA', 'ኌ': 'HUE', 'ኍ': 'HWAE', 
        ...
        'ከ': 'KE', 'ኩ': 'KU', 'ኪ': 'KI', 'ካ': 'KA', 'ኬ': 'KAE', 'ክ': 'K', 'ኮ': 'KO',                     'ኰ': 'KUAA', 'ኲ': 'KUI', 'ኳ': 'KUA', 'ኴ': 'KUE', 'ኵ': 'KWAE', 
        ...
        'ገ': 'GE', 'ጉ': 'GU', 'ጊ': 'GI', 'ጋ': 'GA', 'ጌ': 'GAE', 'ግ': 'G', 'ጎ': 'GO', 'ጐ': 'GO',            'ጒ': 'GUAA', 'ጕ': 'GUI', 'ጓ': 'GUA', 'ጔ': 'GUE', 'ጕ': 'GWAE', 
