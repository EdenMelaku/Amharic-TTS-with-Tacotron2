...
class Decoder(nn.Module):
    def __init__(self, hparams):
        ...
        self.linear_projection = Linear(hparams.decoder_rnn_dim + hparams.encoder_embedding_dim,
                                 hparams.n_mel_channels * hparams.n_frames_per_step)

        self.gate_layer = Linear(hparams.decoder_rnn_dim + hparams.encoder_embedding_dim, 1,
